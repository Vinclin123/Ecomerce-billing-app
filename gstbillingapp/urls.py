...
urlpatterns = [
    ...
    #path('inventoryjson', views.inventoryjson, name='inventoryjson'),
    ...
    path('inventory/check_stock/', views.check_stock, name='check_stock'),
    ...
    path('inventoryjson', views.inventory_json_view, name='inventory_json'),
    ...
    path('get_inventory_stock/', views.get_inventory_stock, name='get_inventory_stock'),
     path('inventory/get_stock/', views.get_stock_view, name='get_stock'),
